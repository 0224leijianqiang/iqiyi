package com.iqiyi.controller.o.order;
...
public class OrderController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd.put("ORDER_DATE", Tools.date2Str(new Date()));	//订单时间
	...
	public ModelAndView goView()throws Exception{
		...
		mv.setViewName("o/order/order_view");
		mv.addObject("pd", pd);
		return mv;
	}	
	/**修改
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("o/order/order_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("o/order/order_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("PAID"));	//2
			vpd.put("var3", varOList.get(i).get("AMOUNT").toString());	//3
			vpd.put("var4", varOList.get(i).get("COUNT").toString());	//4
			vpd.put("var5", varOList.get(i).getString("CITY"));	//5
			vpd.put("var6", varOList.get(i).getString("PHONE"));	//6
			vpd.put("var7", varOList.get(i).getString("PAY_CODE"));	//7
			vpd.put("var8", varOList.get(i).getString("MSG_CODE"));	//8
			vpd.put("var9", varOList.get(i).getString("CHANEL"));	//9
			vpd.put("var10", varOList.get(i).getString("ORDER_DATE"));	//10
			varList.add(vpd);
		}

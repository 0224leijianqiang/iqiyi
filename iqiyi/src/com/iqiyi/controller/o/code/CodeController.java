package com.iqiyi.controller.o.code;
...
public class CodeController extends BaseController {
	...
	String menuUrl = "code/list.do"; //菜单地址(权限用)
	@Resource(name="codeService")
	private CodeManager codeService;
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"新增Code");
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"删除Code");
	...
	public ModelAndView goView()throws Exception{
		...
		mv.setViewName("o/code/code_view");
		mv.addObject("pd", pd);
		return mv;
	}	
	/**修改
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改Code");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"列表Code");
		...
		mv.setViewName("o/code/code_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("o/code/code_edit");
	...
	public Object deleteAll() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"批量删除Code");
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"导出Code到excel");
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var4", varOList.get(i).getString("USED"));	//4
			varList.add(vpd);
		}

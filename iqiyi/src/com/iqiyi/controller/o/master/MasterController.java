package com.iqiyi.controller.o.master;
...
public class MasterController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"新增Master");
		if(!Jurisdiction.buttonJurisdiction(menuUrl, "add")){return null;} //校验权限
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		pd.put("MASTER_ID", this.get32UUID());	//主键
		masterService.save(pd);
	...
	public ModelAndView goView()throws Exception{
		...
		mv.setViewName("o/master/master_view");
		mv.addObject("pd", pd);
		return mv;
	}	
	/**修改
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("o/master/master_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("o/master/master_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("PHONE_NUM"));	//1
			vpd.put("var2", varOList.get(i).getString("NAME"));	//2
			vpd.put("var3", varOList.get(i).getString("LAST_DATE"));	//3
			vpd.put("var4", varOList.get(i).getString("LAST_CODE"));	//4
			varList.add(vpd);
		}

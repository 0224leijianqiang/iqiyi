package com.iqiyi.controller.information.pictures;
...
import com.iqiyi.service.information.pictures.PicturesManager;
...
public class PicturesController extends BaseController {
	...
	public ModelAndView goView(){
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("information/pictures/images");
		mv.addObject("pd", pd);
		return mv;
	}
	@InitBinder

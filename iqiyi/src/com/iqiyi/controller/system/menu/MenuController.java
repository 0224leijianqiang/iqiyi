package com.iqiyi.controller.system.menu;
...
//			BigInteger rights = RightsHelper.sumRights(Tools.str2StrArray(menuIds));//用菜单ID做权处理
			//添加菜单的时候给超级管理员加入菜单归属权
			Role role = roleService.getRoleById("1");	//通过id获取角色对象
			BigInteger rights = new BigInteger(role.getRIGHTS());
			rights = rights.setBit(Integer.parseInt(menu.getMENU_ID()));

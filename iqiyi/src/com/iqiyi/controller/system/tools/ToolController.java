package com.iqiyi.controller.system.tools;
...
import com.iqiyi.util.MapDistance;
import com.iqiyi.util.PageData;
import com.iqiyi.util.PathUtil;
import com.iqiyi.util.TwoDimensionCode;
...
public class ToolController extends BaseController {
	...
	@RequestMapping(value="/alertMsg")
	public ModelAndView alertMsg() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("system/tools/alertMsg");
		mv.addObject("pd", pd);
		return mv;
	}
	/**

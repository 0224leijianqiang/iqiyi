package com.iqiyi.plugin.websocketInstantMsg;
...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("wei.jiangming@21vianet.com")){
			this.userjoin(message.replaceFirst("wei.jiangming@21vianet.com", ""),conn);
		}if(null != message && message.startsWith("Leavewei.jiangming@21vianet.com")){
			this.userLeave(conn);

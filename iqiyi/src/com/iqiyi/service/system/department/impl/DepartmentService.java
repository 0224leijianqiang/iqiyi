package com.iqiyi.service.system.department.impl;
...
public class DepartmentService implements DepartmentManager{
	...
	@Override
	public List<PageData> listAllTree(PageData params,List<PageData> list,String levels) throws Exception {
		// TODO Auto-generated method stub
		@SuppressWarnings("unchecked")
		List<PageData> pds = (List<PageData>)dao.findForList("DepartmentMapper.listAllTree",params);
		for(PageData pd:pds){
			list.add(pd);
			pd.put("NAMES",levels+pd.getString("NAME"));
			pd.put("PARENT_ID", pd.get("DEPARTMENT_ID"));
			listAllTree(pd, list,levels+"---");
		}
		return pds;
	}
}

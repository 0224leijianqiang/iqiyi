...
Dialog.prototype.close = function(dom) {
...
Dialog.prototype.autoClose = function() {
    ...
    this.AutoClose -= 1;
    topWin.$id("_Title_" + this.ID).innerHTML = this.AutoClose + " Second Auto Closed";
    if (this.AutoClose <= 0) {
        this.close()
    } else {
        var a = this;
...
Dialog.getInstance = function(b) {
    ...
    if (!a) {
        alert("Did not take the corresponding ID pop-up box page object")
    }
    try {
...
Dialog.close = function(b) {
    if (topWin.Dialog._dialogArray.length > 0) {
        ...
        if (a.MsgForESC) {
            ...
            a.cancelButton.onclick.apply(a.cancelButton, [b])
        }
    }
};
Dialog.alert = function(f, c, a, b) {
    ...
    d.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">		<tr><td align="right"></td>			<td align="left" id="Message_' + this.ID + '" style="font-size:12pt">' + f + "</td></tr>	</table>";
    d.show();
...
Dialog.confirm = function(g, c, b, a, d) {
    ...
    f.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">		<tr><td align="left" id="Message_' + this.ID + '" style="font-size:12pt">' + g + "</td></tr>	</table>";
    f.show();

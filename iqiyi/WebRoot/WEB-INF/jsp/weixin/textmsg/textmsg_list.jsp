							...
							<tr>
								<td>
									...
									<span class="input-icon">
										<input class="nav-search-input" autocomplete="off" id="nav-search-input" type="text" name="KEYWORD" value="${pd.KEYWORD }" placeholder="Enter search keywords" />
								...
								<td style="vertical-align:top;padding-left:2px;"><button class="btn btn-mini btn-light" onclick="search();"  title="Search"><i id="nav-search-icon" class="ace-icon fa fa-search bigger-110 nav-search-icon blue"></i></button></td>
								<c:if test="${QX.cha == 1 }">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td style="width: 100px;" class="center">
												...
												<c:if test="${QX.edit == 1 }">
												<a style="cursor:pointer;" class="green" onclick="edit('${var.TEXTMSG_ID}');" title="Edit">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>
												</c:if>
												<c:if test="${QX.del == 1 }">
												<a style="cursor:pointer;" class="red" onclick="del('${var.TEXTMSG_ID}');" title="Delete">
					...
					<table style="width:100%;">
						<tr>
							<td style="vertical-align:top;">
								<c:if test="${QX.add == 1 }">
								<a class="btn btn-sm btn-success" onclick="add();">Added</a>
								</c:if>
								<c:if test="${QX.del == 1 }">
								<a class="btn btn-sm btn-danger" onclick="makeAll('Are you sure you want to delete the selected data ?');" title="Batch Delete" ><i class='ace-icon fa fa-trash-o bigger-120'></i></a>
								</c:if>
							</td>

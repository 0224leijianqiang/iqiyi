								...
								<tr>
									<td>
										...
										<span class="input-icon">
											<input autocomplete="off" class="nav-search-input" id="nav-search-input" type="text" name="KEYWORD" value="${pd.KEYWORD }" placeholder="Enter search keywords" />
										...
										<c:forEach items="${varList}" var="var" varStatus="vs">
											<tr>
												...
												<td class="center" style="width: 100px;">
													...
													<c:if test="${QX.edit == 1 }">
													<a style="cursor:pointer;" class="green" onclick="edit('${var.IMGMSG_ID}');" title="Edit">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
													</a>
													</c:if>
													<c:if test="${QX.del == 1 }">
													<a style="cursor:pointer;" class="red" onclick="del('${var.IMGMSG_ID}');" title="Delete">

...
<html lang="en">
	<head>
		...
		.commitbox{width:96%; padding-left:70px; padding-top:69px; position:absolute; top:0px; z-index:99999;}
		.commitbox_inner{width:100%; height:235px;  margin:2px auto; background:#efefef; border-radius:5px;}
		.commitbox_top{width:100%; height:263px; margin-bottom:10px; padding-top:10px; background:#FFF; border-radius:5px; box-shadow:1px 1px 3px #e8e8e8;}
						        	...
						        	<table>
						        		<tr height="42px;">
						        			...
						        			<td style="padding-bottom: 5px;">
												...
												<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio_blob" onclick="setType('Blob');" type="radio" value="icon-edit"><span class="lbl">Blob</span></label>
												<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio_bit" onclick="setType('Bit');" type="radio" value="icon-edit"><span class="lbl">Bit</span></label>
											</td>
						        		</tr>
						        		<tr height="42px;">
						        		...
						        		<tr height="42px;">
						        			...
						        			<td style="padding-left: 26px;" ><div class="commitbox_cen">
								                <div class="left" id="cityname"></div>
								                <div class="right"><span class="save" onClick="saveD()">Save</span>&nbsp;&nbsp;<span class="quxiao" onClick="cancel_pl()">Close</span></div>
								            </div></td>
						        		</tr>
						        		<tr>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover" style="margin-top: 5px;">
								...
								<thead>
									<tr>
										...
										<th class="center" style="width:69px;">Operate</th>
									</tr>
								</thead>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="text-align: center;" colspan="100">
									<a class="btn btn-app btn-success btn-xs" onclick="dialog_open();"><i class="ace-icon glyphicon glyphicon-plus"></i>Added</a>
									<a class="btn btn-app btn-success btn-xs" onclick="save();" id="productc"><i class="ace-icon fa fa-print bigger-160"></i>生成</a>
									<a class="btn btn-app btn-danger btn-xs" onclick="top.Dialog.close();"><i class="ace-icon fa fa-reply icon-only"></i>Close</a>
								</td>
							</tr>
						</table>
						</div>

							...
							<tr>
								<td style="width:10%">
									...
									<span class="input-icon">
										<input type="text" placeholder="Enter search keywords" class="nav-search-input" id="nav-search-input" name="keywords" value="${pd.keywords }" autocomplete="off" />
										<i class="ace-icon fa fa-search nav-search-icon"></i>
									</span>
									</div>
								</td>
								<td style="vertical-align:top;padding-left:2px;width:42px;"><a class="btn btn-light btn-xs" onclick="searchs();"  title="Search"><i id="nav-search-icon" class="ace-icon fa fa-search bigger-110 nav-search-icon blue"></i></a></td>
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${QX.edit == 1 }">
													<a class="btn btn-xs btn-success" title="Edit" onclick="productCode('${var.CREATECODE_ID}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															...
															<c:if test="${QX.del == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="del('${var.CREATECODE_ID}');" class="tooltip-error" data-rel="tooltip" title="Delete">
																	<span class="red">

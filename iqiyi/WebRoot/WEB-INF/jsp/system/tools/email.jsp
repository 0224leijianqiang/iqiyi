								...
								<table style="width:100%;" id="xtable">
									<tr>
										<td style="margin-top:0px;">
											 ...
											 <div style="float: right;width:10%;"><a class='btn btn-mini btn-info' title="Edit邮箱" onclick="dialog_open();"><i class='ace-icon fa fa-pencil-square-o bigger-120'></i></a></div>
										</td>
									</tr>
									<tr>
										<td>

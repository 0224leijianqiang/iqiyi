			  	...
			  	<div class="commitbox_inner">
			        <div class="commitbox_top">
			            ...
			            <div class="commitbox_cen">
			                ...
			                <div class="right"><span class="save" onClick="saveEmail()">Save</span>&nbsp;&nbsp;<span class="quxiao" onClick="Close_pl()">Close</span></div>
			            </div>
			        </div>
			  	</div>
		  	</div>
		...
		<table style="width:98%;margin-top: 10px;margin-left: 9px;" >
			<tr>
				<td style="margin-top:0px;">
					 ...
					 <div style="float: right;margin-right: 12px;" style="width:19%"><a class='btn btn-mini btn-info' title="Edit邮箱" onclick="dialog_open();"><i class='ace-icon fa fa-pencil-square-o bigger-120'></i></a></div>
				</td>
			</tr>
			<tr>
				<td>

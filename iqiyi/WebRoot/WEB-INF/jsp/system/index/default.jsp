					...
					<div class="row">
						...
						<%-- 	<div class="tabbable">
						            <ul class="nav nav-tabs" id="myTab">
						              <li class="active"><a data-toggle="tab" href="#home"><i class="green icon-home bigger-110"></i> 待处理报修</a></li>
						              <li><a data-toggle="tab" href="#profile"><i class="green icon-cog bigger-110"></i>待处理请求</a></li>
						              <li><a data-toggle="tab" href="#profile3"><i class="blue icon-cog bigger-110"></i>待处理变更</a></li>
						              <li><a data-toggle="tab" href="#profile4"><i class="green icon-cog bigger-110"></i>待处理任务</a></li>
						            </ul>
						            <div class="tab-content">
									  ...
									  <div id="profile" class="tab-pane">
										...
										<table class="center" style="width:100%" >
											<tr>
												<td style="text-align: center;" colspan="100">
													<a class="btn btn-mini btn-primary" onclick="save2();">Save</a>
													<a class="btn btn-mini btn-danger" onclick="top.Dialog.close();">Close</a>
												</td>
											</tr>
										</table>
									  ...
									  <div id="profile3" class="tab-pane">
										...
										<table class="center" style="width:100%" >
											<tr>
												<td style="text-align: center;" colspan="100">
													<a class="btn btn-mini btn-primary" onclick="save3();">Save</a>
													<a class="btn btn-mini btn-danger" onclick="top.Dialog.close();">Close</a>
												</td>
											</tr>
										</table>

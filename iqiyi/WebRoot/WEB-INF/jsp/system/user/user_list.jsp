					...
					<div class="row">
						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="padding-left:2px;"><input class="span10 date-picker" name="lastLoginStart" id="lastLoginStart"  value="${pd.lastLoginStart}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:120px;" placeholder="Begin Date" title="Last Login Begin"/></td>
								<td style="padding-left:2px;"><input class="span10 date-picker" name="lastLoginEnd" name="lastLoginEnd"  value="${pd.lastLoginEnd}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:120px;" placeholder="End Date" title="Last Login End"/></td>
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="ROLE_ID" id="role_id" data-placeholder="Please Check Role" style="vertical-align:top;">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									...
									<th class="center">Last Login Time</th>
							...
							<c:choose>
								<c:when test="${not empty userList}">
									...
									<c:if test="${QX.cha == 0 }">
										<tr>
											<td colspan="10" class="center">You do not have permission</td>
										</tr>
									</c:if>
								</c:when>
								<c:otherwise>
					...
					<table style="width:100%;">
						<tr>
							<td style="vertical-align:top;">
								<c:if test="${QX.add == 1 }">
								<a class="btn btn-mini btn-primary" onclick="add();">Added User</a>
								</c:if>
								<c:if test="${QX.del == 1 }">
...
function delUser(userId,msg){
	bootbox.confirm("确定要Delete["+msg+"]吗?", function(result) {
		if(result) {
			top.jzts();

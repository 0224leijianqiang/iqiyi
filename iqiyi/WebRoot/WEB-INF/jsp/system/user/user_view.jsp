								...
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td><input type="text" name="NUMBER" id="NUMBER" value="${pd.NUMBER }" maxlength="32" title="工号" onblur="hasN('${pd.USERNAME }')" style="width:98%;" disabled="disabled"/></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" name="BZ" id="BZ"value="${pd.BZ }"  maxlength="64" title="职位" style="width:98%;" disabled="disabled"/></td>
										</tr>
									</table>
									</div>
								</form>

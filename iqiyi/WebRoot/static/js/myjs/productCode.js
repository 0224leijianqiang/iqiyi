	...
	function saveD(){
		...
		var fields = dname + ',' + dtype + ',' + dbz + ',' + isQian + ',' + ddefault + ',' + flength;
		if(msgIndex == ''){
			arrayField(fields);
		}else{
	...
	function editField(value,msgIndex){
		...
		if(efieldarray[1] == 'String'){
			...
			$("#dtype").val('Integer');
		}else if(efieldarray[1] =='Blob'){
			$("#form-field-radio_blob").attr("checked",true);
			$("#form-field-radio_blob").click();
			$("#dtype").val('Blob');
		}else if(efieldarray[1] =='Bit')
		{
			$("#form-field-radio_bit").attr("checked",true);
			$("#form-field-radio_bit").click();
			$("#dtype").val('Bit');
		}
		else{
